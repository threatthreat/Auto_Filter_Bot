...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002671798198'))
REQST_CHANNEL = int(environ.get('REQST_CHANNEL_ID', '-1002512625570'))
SUPPORT_CHAT_ID = int(environ.get('SUPPORT_CHAT_ID', '-1002587184746'))
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002583130466'))
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

# Tutorials (Only two needed)
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/super_chat70')
